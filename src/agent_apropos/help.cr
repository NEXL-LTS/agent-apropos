...
module AgentApropos
  module Help
    ...
    PATHS = [
      ...
      PathEntry.new(".codex/hooks.json", "PreToolUse/PostToolUse hook wiring for Codex CLI, matched on its apply_patch tool (generated by agent-apropos init --tool codex, or auto-detected)."),
      PathEntry.new(".codex/skills/", "Generated skill wrappers — read by Codex CLI from its own repo-local skills root."),
    ...
    COMMANDS = [
      Command.new("init", "Bootstrap the convention structure into a repo",
        ...
        ".github/hooks/agent-apropos.json, Codex CLI into .codex/hooks.json), " \
        "or pass --tool claude / --tool opencode / --tool gemini / " \
        "--tool copilot / --tool codex (repeatable) " \
      ...
      Command.new("doctor", "Check the environment",
        ...
        "the Copilot CLI postToolUse wiring, the Codex CLI PreToolUse/" \
        "PostToolUse wiring, whether agent-apropos and Claude Code " \
    ...
    AGENT_NOTE = "If you are an AI agent reading this (Claude Code, OpenCode, " \
                 "Gemini CLI, GitHub Copilot CLI, Codex CLI, or other): agent-apropos injected context because a rule matched the file " \
